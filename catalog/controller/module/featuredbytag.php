<?php
class ControllerModuleFeaturedbytag extends Controller
{
    ...
    protected function index($setting)
    {
        ...
        eval('$products = $this->model_module_'.$this->module.'->get'.$this->module.'Products($setting["limit"], $setting["tag"]['.(int)$this->config->get('config_language_id').']);');
